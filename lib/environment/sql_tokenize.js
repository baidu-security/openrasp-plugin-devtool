...
SQLLexer.prototype.literalNames = [ null, null, null, "'\"'", "'''", null, 
                                    null, null, "'*/'", null, null, "','", 
                                    "'.'" ];

SQLLexer.prototype.symbolicNames = [ null, "Identifier", "Number", "DOUBLE_QUOTE", 
                                     "SINGLE_QUOTE", "StringLiteral", "EscapeSequence", 
                                     "BLOCK_COMMENT_START", "BLOCK_COMMENT_END", 
                                     "BLOCK_COMMENT", "POUND_COMMENT", "COMMA", 
                                     "DOT", "SYMBOL", "WS" ];

SQLLexer.prototype.ruleNames = [ "Identifier", "Number", "DOUBLE_QUOTE", 
                                 "SINGLE_QUOTE", "StringLiteral", "EscapeSequence", 
                                 "BLOCK_COMMENT_START", "BLOCK_COMMENT_END", 
                                 "BLOCK_COMMENT", "POUND_COMMENT", "COMMA", 
                                 "DOT", "SYMBOL", "WS" ];
